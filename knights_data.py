...
# Short, game-native wording (1000 to succeed).
_KNIGHT_PASSIVE_NOTES = {
    "LONER": "+100 when alone",
    "DEADLY_WEAPON": "+10,000 on Assassination",
    "WISH_GRANTING_LAMP": "+10,000 on every quest",
    "AMBER_EYE": "+800 on replayed quests",
    "DEMON_DECOCTION": "+10,000 on replayed quests",
    "KIND_HEARTED": "+100 if people like it, −100 if not",
    "NOBLE_SOUL": "+100 if nobles like it, −100 if not",
    "TRUE_NOBLE_SOUL": "+100 / −100 based on overall satisfaction",
    "SYPHON": "+25 per kill (Edith)",
    "CHEESE_LOVER": "+100 if also cheesy",
    "SADDISTIC": "+100 if killing involved",
    "SERRATED_BLADE": "+100 if killing involved",
    "GRANNYS_HERBAL_TEA": "+100 if people like it, −100 if not",
    "FINE_WINE": "+100 if nobles like it, −100 if not",
    "LASTING_IMPRESSION": "+100 on Gideon's familiar lands",
    "TIME_PERCEPTION": "+100 on Epicrate's past quests",
    "REVOLUTIONAR": "±200 based on people vs nobles happiness",
    "PATIENT": "+100 if quest lasts >1 day",
    "TIMID": "−100 when alone",
    "TRUE_DRAGON_KNIGHT": "+50, +100 on fights",
    "BRUTAL": "+150 on fights, −150 otherwise",
    "LOYAL": "±200 based on companions' affinity",
    "NOBILITY_PRIMES": "±200 based on nobles vs people",
    "SPEEDSTER": "+50 per day saved",
    "OVERWORKED": "−50 per extra day",
    "BELIEVER": "Small bonus when scholars happy",
    ...
    "PERFECT_ARMOR": "Negates damage for allies, + damage per ally for self",
    ...
    "POACHER": "+1 Merchants on success (25% chance)",
    "NOBLES_DEFENDER": "+1 Nobles on success (25% chance)",
    "SCHOLAR": "+1 Scholars on success (25% chance)",
    "IDOL": "+1 People on success (25% chance)",
    "FORTUNATE": "50% chance to do one tier better",
    "PROTAGONIST": "+100 when already ahead",
    "CHEESY": "Enables cheese-lover bonus",
}
