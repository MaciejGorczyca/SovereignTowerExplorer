...
# inventory_data.PASSIVE_NOTES). Score is internal quest outcome points; UI
# shows ×100 (gauge_controller.gd:103, knight_score_recap.gd:21).
_KNIGHT_PASSIVE_NOTES = {
    "LONER": "+1 internal (≈ +100 pts) when sent alone (special_cases.gd:9).",
    "DEADLY_WEAPON": "+100 internal (≈ +10,000 pts) on Assassination (special_cases.gd:17).",
    "WISH_GRANTING_LAMP": "+100 internal (≈ +10,000 pts) on every quest (special_cases.gd:25).",
    ...
    "SYPHON": "Bonus = Edith's bonus_for_kills 0.25 per kill internal (≈ +25 pts per kill) (special_cases.gd:73).",
    "CHEESE_LOVER": "+1 internal (≈ +100 pts) if also has CHEESY (special_cases.gd:85).",
    "SADDISTIC": "+1 internal (≈ +100 pts) when killing (special_cases.gd:93).",
    "SERRATED_BLADE": "+1 internal (≈ +100 pts) when killing (special_cases.gd:268).",
    "GRANNYS_HERBAL_TEA": "+1/−1 internal (≈ ±100 pts) mirroring people reward (special_cases.gd:276).",
    "FINE_WINE": "+1/−1 internal (≈ ±100 pts) mirroring nobles reward (special_cases.gd:286).",
    "LASTING_IMPRESSION": "+1 internal (≈ +100 pts) on Gideon's known locations (special_cases.gd:101, Gideon only).",
    "TIME_PERCEPTION": "+1 internal (≈ +100 pts) on Epicrate's completed quests (special_cases.gd:112, Epicrate only).",
    "REVOLUTIONAR": "Score clamp((people−nobles)×0.2 internal ≈ ×20 pts, −2..2 ≈ −200..+200) (special_cases.gd:123).",
    ...
    "TRUE_DRAGON_KNIGHT": "+0.5 internal (≈ +50 pts), doubled to +1.0 (≈ +100 pts) on Hunt/Confront/Duel/Assassination (special_cases.gd:149).",
    "BRUTAL": "+1.5 internal (≈ +150 pts) on combat quests, else −1.5 (≈ −150 pts) (special_cases.gd:158).",
    "LOYAL": "Score clamp(avg affinity×0.25 internal ≈ ×25 pts, −2..2 ≈ −200..+200) with others (special_cases.gd:167).",
    "NOBILITY_PRIMES": "Score clamp((nobles−people)×0.2 internal ≈ ×20 pts, −2..2 ≈ −200..+200) (special_cases.gd:182).",
    ...
    "BELIEVER": "+scholars×0.025 internal (≈ ×2.5 pts) when scholars ≥10 (special_cases.gd:209).",
    ...
    "PERFECT_ARMOR": "Damage −100 to others' damage if ally has it; +0.75×base×(n−1) if self has it (special_cases.gd:319).",
    ...
    "FORTUNATE": "50% chance to improve outcome by one tier ≈ +1 internal (+100 pts) (special_cases.gd:401).",
    "PROTAGONIST": "+1 internal (≈ +100 pts) when bearer already has highest score (special_cases.gd:416).",
